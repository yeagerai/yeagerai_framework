...
class AbstractWorkflow(AbstractComponent):
    ...
    ## then instantiating the class = ws.connect(), and transform() = ws.send_msg()
    @classmethod
    @final
    ...
    async def transform(self, args: typing.Any, callbacks: typing.Any) -> typing.Any:
        ...
        print(f"Executing the transform of the {type(self).__name__} workflow...")
        ...
        for node_idx in sorted_nodes:
            ...
            output_dict = await component_instance.transform(input_dict, callbacks)
